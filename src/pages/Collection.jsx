...
const toggleCategory = (e) => {
  ...
  if (category.includes(value)) {
    ...
    setCategory([value]); // only keep one
  }
};
...
const toggleSubCategory = (e) => {
  ...
  if (subCategory.includes(value)) {
    setSubCategory([]); // unselect if clicked again
  } else {
    setSubCategory([value]); // only keep one
  }
};
...
useEffect(()=>{
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap'>
      {/*Filter Option */}
